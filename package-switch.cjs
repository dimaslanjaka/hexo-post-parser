...
const local = {
  ...
  'google-news-sitemap':
    'file:../google-news-sitemap/release/google-news-sitemap.tgz',
...
const production = {
  ...
  '@types/hexo':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo.tgz',
  hexo: 'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo.tgz',
  'hexo-asset-link':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-asset-link.tgz',
  'hexo-cli':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-cli.tgz',
  'hexo-front-matter':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-front-matter.tgz',
  'hexo-log':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-log.tgz',
  'hexo-util':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-util.tgz',
  'hexo-server':
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/hexo-server.tgz',
  warehouse:
    'https://github.com/dimaslanjaka/hexo/raw/monorepo-v7/releases/warehouse.tgz',
  'hexo-seo':
    'https://github.com/dimaslanjaka/hexo-seo/raw/pre-release/release/hexo-seo.tgz',
  'hexo-is':
    'https://github.com/dimaslanjaka/hexo-is/raw/master/release/hexo-is.tgz',
  'markdown-it':
    'https://github.com/dimaslanjaka/markdown-it/raw/17ccc82/release/markdown-it.tgz',
  'hexo-renderers':
    'https://github.com/dimaslanjaka/hexo-renderers/raw/3f727de/release/hexo-renderers.tgz',
  'hexo-shortcodes':
    'https://github.com/dimaslanjaka/hexo-shortcodes/raw/f70a1c0/release/hexo-shortcodes.tgz',
  ...
  'sbg-api':
    'https://github.com/dimaslanjaka/static-blog-generator/raw/sbg-api/packages/sbg-api/release/sbg-api.tgz',
  'sbg-cli':
    'https://github.com/dimaslanjaka/static-blog-generator/raw/master/packages/sbg-cli/release/sbg-cli.tgz',
  'sbg-server':
  ...
  'hexo-post-parser':
    'https://github.com/dimaslanjaka/hexo-post-parser/raw/pre-release/release/hexo-post-parser.tgz',
  'cross-spawn':
    'https://github.com/dimaslanjaka/node-cross-spawn/raw/private/release/cross-spawn.tgz',
  'git-command-helper':
 ...
 */
async function updatePackageSha(
  repoOwner,
  repoName,
  branch,
  packageName,
  ...
  try {
    ...
    throw new Error(
      `Error updating package SHA for ${packageName}:`,
      message,
      errorUrl
    );
  }
...
async function main() {
  ...
  if (pkg.dependencies) {
    ...
    if (pkg.dependencies[`@types/${pkg.name}`])
      delete pkg.dependencies[`@types/${pkg.name}`];
  }
  if (pkg.devDependencies) {
    ...
    if (pkg.devDependencies[`@types/${pkg.name}`])
      delete pkg.devDependencies[`@types/${pkg.name}`];
  }
  if (pkg.resolutions) {
    pkg.resolutions = Object.fromEntries(
      Object.entries(pkg.resolutions).sort()
    );
    if (pkg.resolutions[pkg.name]) delete pkg.resolutions[pkg.name];
    if (pkg.resolutions[`@types/${pkg.name}`])
      delete pkg.resolutions[`@types/${pkg.name}`];
  }
  if (pkg.overrides) {
    ...
    if (pkg.overrides[`@types/${pkg.name}`])
      delete pkg.overrides[`@types/${pkg.name}`];
  }
